...
//LCD_RS//dc  
#define LCD_RS_SET      HAL_GPIO_WritePin(LCD_WR_RS_PORT,LCD_WR_RS_PIN,GPIO_PIN_SET)//PC4 
#define LCD_RS_RESET    HAL_GPIO_WritePin(LCD_WR_RS_PORT,LCD_WR_RS_PIN,GPIO_PIN_RESET)
//LCD_CS  
...
void LCD_Test(void){
    ...
    extern unsigned char yeisonint_logo[];
    ST7735_LCD_Driver.DrawBitmap(&st7735_pObj,0,0,yeisonint_logo);
}
